...
<div class="container-inline">
	...
	<?php endif; ?>
	*/ ?>
	<?php /* <?php print $search_form; ?> */ 
		print $search['search_block_form']; // Text input area wrapped in a div.
	?>
	<span class="search-submitter">&nbsp;</span>
	<?php
 		print $search['submit']; // Form submit button.
 		print $search['hidden']; // Hidden form elements. Used to validate forms when submitted.
 	?>
</div>
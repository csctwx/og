<?php
// I think this page is unused... delete after verifying
...
?>
	...
	<div class="filter-input">
		<h4 class="curly">Find a store near you</h4>
		<div class="filter-inside">
			<div class="input-field-wrapper">
				<input id="zip-search" type="text" value=""/>
			</div>
	...
	<script src="/sites/all/themes/og/js/stores.js?id=4"></script>
